...
Q_DECLARE_METATYPE(kinema::api::AllDebridUser)
Q_DECLARE_METATYPE(kinema::api::AdAddMagnetResult)
Q_DECLARE_METATYPE(kinema::api::AdMagnetStatus)
Q_DECLARE_METATYPE(kinema::api::AdMagnetFile)
Q_DECLARE_METATYPE(kinema::api::AdUnlockedLink)
