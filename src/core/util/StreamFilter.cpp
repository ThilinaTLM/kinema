...
bool categoryMatchesToken(const domain::Stream& s, const QString& token)
{
...
bool matchesBlocklist(const domain::Stream& s, const QStringList& blocklist)
{
...
QList<domain::Stream> apply(const QList<domain::Stream>& in,
