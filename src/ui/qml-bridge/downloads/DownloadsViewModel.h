...
class DownloadsViewModel : public QObject
{
    ...
    Q_PROPERTY(qint64 totalDownloadRateBps READ totalDownloadRateBps NOTIFY countsChanged)
    Q_PROPERTY(QString totalDownloadRateText READ totalDownloadRateText NOTIFY countsChanged)
