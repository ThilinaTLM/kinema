...
void emitStatus(QObject* sink, QString text, int durationMs)
{
    ...
    QMetaObject::invokeMethod(
        sink, "statusMessage", Qt::DirectConnection, Q_ARG(QString, text), Q_ARG(int, durationMs));
}

QCoro::Task<QString> resolveImdbId(api::TmdbClient* tmdb, int tmdbId, domain::MediaKind kind)
{
                                     ...
                                     QString title)
{
    ...
    try {
        ...
        emitStatus(sink, core::describeError(e, "add to library"), 5000);
    }
    co_return;
}
                                    ...
                                    QString title)
{
    ...
    try {
        ...
        emitStatus(sink, core::describeError(e, "mark watched"), 5000);
    }
    co_return;
}
