...
class SubtitlesViewModel : public QObject
{
    ...
    // `ShellViewModel::exposeContextProperties`) and as a context
...
Q_SIGNALS:
    ...
    /// listens via `ShellViewModel` and sideloads the file when
    ...
    /// category (`ShellViewModel::requestSettings("subtitles")`).
