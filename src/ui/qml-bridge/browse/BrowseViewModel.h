...
public Q_SLOTS:
    ...
    /// Called by `ShellViewModel` when a Discover rail's "Show all"
...
Q_SIGNALS:
    ...
    /// Routed by `ShellViewModel` to a passive notification for
    ...
    /// `ShellViewModel` forwards to a passive notification for
