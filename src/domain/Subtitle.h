...
Q_DECLARE_METATYPE(kinema::domain::SubtitleHit)
Q_DECLARE_METATYPE(kinema::domain::SubtitleSearchQuery)
Q_DECLARE_METATYPE(kinema::domain::SubtitleDownloadTicket)
