...
Q_DECLARE_METATYPE(kinema::domain::PlaybackKey)
Q_DECLARE_METATYPE(kinema::domain::HistoryStreamRef)
Q_DECLARE_METATYPE(kinema::domain::HistoryEntry)
Q_DECLARE_METATYPE(kinema::domain::PlaybackContext)
