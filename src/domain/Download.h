 ...
 *
 * Constructed from `domain::Stream` + `domain::PlaybackContext` by the
 * download manager.
 */
struct AssetRef {
    PlaybackKey key;
...
Q_DECLARE_METATYPE(kinema::domain::AssetRef)
Q_DECLARE_METATYPE(kinema::domain::DownloadItem)
Q_DECLARE_METATYPE(kinema::domain::DownloadBackendKind)
Q_DECLARE_METATYPE(kinema::domain::DownloadState)
Q_DECLARE_METATYPE(kinema::domain::DownloadMode)
Q_DECLARE_METATYPE(kinema::domain::CacheDisposition)
