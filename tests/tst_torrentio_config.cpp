...
private Q_SLOTS:
    ...
    void exclusions_resolutionsBeforeCategories()
    {
        ...
        QCOMPARE(toPathSegment(o), QStringLiteral("sort=seeders|qualityfilter=1080p,hdr"));
    }
    ...
    void exclusions_onlyCategories_renders()
    {
        ...
        QCOMPARE(toPathSegment(o), QStringLiteral("sort=seeders|qualityfilter=cam,scr"));
    }
    ...
    void exclusions_onlyResolutions_renders()
    {
        ...
        QCOMPARE(toPathSegment(o), QStringLiteral("sort=seeders|qualityfilter=480p"));
    }
    ...
    void debrid_bothFieldsSet_appendsLastSegment()
    {
        ...
        QCOMPARE(toPathSegment(o), QStringLiteral("sort=seeders|realdebrid=rd-token"));
    }
    ...
    void debrid_alldebrid_appendsLastSegment()
    {
        ...
        QCOMPARE(toPathSegment(o), QStringLiteral("sort=seeders|alldebrid=ad-key"));
    }
    ...
    void debrid_segmentOrderIsAfterQualityFilterAndProviders()
    {
        ...
        QCOMPARE(toPathSegment(o),
                 QStringLiteral("sort=seeders|qualityfilter=4k|providers=yts"
                                "|realdebrid=rd-token"));
    }
